...
# Class to flatten raw_datasets or compute the statistical difference between cases.
class PersonDistanceMetricsNoOrdering:
    ...
    # Fit raw_datasets to normal distribution and use parameters as instances
    ...
    # This defines the distance between raw_datasets based on the statistical
...
# Class to compare two time ordered raw_datasets.
class PersonDistanceMetricsOrdering:

    extreme_value = sys.float_info.max
    tiny_value = 0.000001

    # Directly pair up the raw_datasets and computer the euclidean
    ...
    # Compute the distance between two raw_datasets given a set lag.

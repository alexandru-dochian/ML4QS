...
from book.util.VisualizeDataset import VisualizeDataset, util
...
for milliseconds_per_instance in GRANULARITIES:
    print(f'Creating numerical raw_datasets from files in {DATASET_PATH} using granularity {milliseconds_per_instance}.')
